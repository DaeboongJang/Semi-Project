...
//			System.out.println("post_no : " + post_no);
			...
			int totalCnt = dao.getBoardListCnt(id);
			...
			BoardDTO idDto = dao.selectFromId(id);
			request.setAttribute("idDto", idDto);
			...
			for(BoardDTO dto : list) {
				if(dto.getPost_writer().equals(id)) {
					System.out.println("aaaaaaaaaaaaa : " + dto.getPost_no());
					if (list != null) {
