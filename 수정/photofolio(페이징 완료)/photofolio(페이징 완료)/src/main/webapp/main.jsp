	                       ...
	                       <div class="infoBox_main">
	                           ...
	                           <div id="infoBox_main_profile">
	                           		...
	                           		<c:forEach items="${mlist }" var="mlist">
	                           			<c:if test="${list.getPost_writer() == mlist.getUser_id() }"> 
	                           			<c:choose>
	                           				<c:when test="${ mlist.getUser_type() == 3}">	                           					
	                           					<img src="${pageContext.request.contextPath}${mlist.getProfilePhoto_path()}" id="info_profilePhoto">
	                           				</c:when>
	                           				<c:otherwise>
	                           				 <img src="${pageContext.request.contextPath}/upload/${mlist.getProfilePhoto_path()}" id="info_profilePhoto">
	                           				</c:otherwise>							   
									   	 </c:choose>
									   	 </c:if>
									</c:forEach> 
